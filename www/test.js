...
Async_Api.prototype.foo = function(x,y,__callb) {
...
Client.main = function() {
	...
	var proxy = new ApiProxy(cnx.resolve("inst"));
	haxe.Log.trace("ciao",{ fileName : "Client.hx", lineNumber : 12, className : "Client", methodName : "main"});
	proxy.foo(1,2,function(res) {
		haxe.Log.trace(res,{ fileName : "Client.hx", lineNumber : 15, className : "Client", methodName : "main"});
	});
}
